package party.lemons.lklib.entity.render;
...
public class LKBoatRenderer extends EntityRenderer<LKBoatEntity>
{
    private final Map<BoatType, Identifier> textures = Maps.newHashMap();
    protected final BoatEntityModel model = new BoatEntityModel();

    public LKBoatRenderer(EntityRenderDispatcher dispatcher)
    {
        super(dispatcher);
        this.shadowRadius = 0.8F;
    }

    public void render(LKBoatEntity boatEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i)
    {
        matrixStack.push();
    ...
    public Identifier getTexture(LKBoatEntity boatEntity)
    {

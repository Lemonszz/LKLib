package party.lemons.lklib.item;
...
public class LKBoatItem extends LKItem
{
    private final Supplier<BoatType> type;

    public LKBoatItem(Supplier<BoatType> boatType, Item.Settings settings)
    {
        super(settings);
        this.type = boatType;
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand)
    {
        ...
        }else
        {
            ...
            {
                LKBoatEntity boatEntity = createBoat(world, hitResult.getPos().x, hitResult.getPos().y, hitResult.getPos().z, user.yaw);
    ...
    public LKBoatEntity createBoat(World world, double x, double y, double z, float yaw)
    {
        LKBoatEntity boatEntity = new LKBoatEntity(world, x, y, z);
